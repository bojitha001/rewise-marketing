    ...
    <div className="px-24 py-24 bg-gradient-to-b from-white to-blue-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16 flex gap-5">
          <p className="text-center text-7xl font-light" style={{ color: '#0040c1' }} >Frequently Asked</p>
          <p className="text-center text-7xl font-light"> Questions</p>
        </div>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="bg-white rounded-lg overflow-hidden border border-gray-200" >
              <button
                ...
                className="w-full px-8 py-6 flex items-center justify-between hover:bg-blue-50 transition"
              >
