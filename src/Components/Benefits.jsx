...
const Benefits = () => {
  ...
  return (
    <>
      ...
      <div className="h-screen text-white relative top-0 left-0 right-0 z-30 mt-24 benifit-section bg-[#0040c1] rounded-3xl overflow-hidden flex flex-col px-16 py-12">
        {/* Top row */}
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white/70 text-sm font-light tracking-widest uppercase">Benefit 01</span>
          </div>
        ...
        <div className="flex-1 flex items-center">
          <div className="flex items-end justify-between w-full">
            ...
            {/* Stats card */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 min-w-[260px]">
              <p className="text-white/60 text-sm mb-2 font-light">Retention boost</p>
              <p className="text-6xl font-light text-white mb-1">3×</p>
